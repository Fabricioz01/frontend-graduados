        ...
        <div class="row align-items-center g-0 px-3 py-3 vh-100">
          ...
          <div class="account-page-bg rounded-4">
                            <div class="auth-user-review text-center">
                                <ngb-carousel [showNavigationArrows]="false" [showNavigationIndicators]="false" id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
