...
import { ChartOptions } from '@core/interfaces/ui/apexchart.model';
    ...
    series: [
      {
        name: 'Total Income',
        data: [
          1000, 2100, 1800, 4540, 4540, 2300, 2300, 6860, 6860, 3500, 3500,
          2100,
        ],
      },
      {
        name: 'Total Revenue',
        data: [
          2000, 5300, 1100, 1300, 4800, 5200, 7800, 4350, 4750, 7380, 4540,
          4800,
        ],
      },
      {
